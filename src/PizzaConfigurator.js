  ...
  return (
    <form>
      <fieldset>
        ...
        <label>
          <input onChange={handleChange} name="size" type="radio" value="35" />
          35
        </label>
        <label>
          <input onChange={handleChange} name="size" type="radio" value="30" />
          30
        </label>
        <legend>Dough</legend>
        <label>
        ...
        <label>
          <input onChange={handleChange} name="meat" type="radio" value="ham" />
          ham
        </label>
      </fieldset>
